...
[{ price: 300 }].filter(function (v) {
	return v.price > 200;
});
[{ price: 300 }].filter(function (v, i, a) {
	console.log(i);
	console.log(a);
	return v.price > 200;
});
...
var context = {
	items: [{ name: "Handlebars", emotion: "love" }, { name: "Mustache", emotion: "enjoy" }, { name: "Ember", emotion: "want to learn" }]
};

_handlebars2.default.registerHelper('agree_button', function () {
	var emotion = _handlebars2.default.escapeExpression(this.emotion),
	    name = _handlebars2.default.escapeExpression(this.name);

	return new _handlebars2.default.SafeString("<button>I agree. I " + emotion + " " + name + "</button>");
});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
    return "            <li><button class=\"mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent\"\n        onclick=\""
    + container.escapeExpression(container.lambda((depth0 != null ? depth0.agree_button : depth0), depth0))
    + "\">\n            Button\n        </button>\n            </li>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1;

  return "<div class=\"demo-layout-transparent mdl-layout mdl-js-layout\">\n"
    + ((stack1 = container.invokePartial(__webpack_require__(6),depth0,{"name":"header","data":data,"indent":"    ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
